...
class Helpers
{
     ...
     * @return bool
     */
    public static function isTimestamp($timestamp)// phpcs:ignore
    {
     ...
     * @return mixed|string
     */
    public static function iso3166Alpha3($alpha2)// phpcs:ignore
    {
        $map = [
            "AD" => "AND",
            "AE" => "ARE",
     ...
     * @return string
     */
    public static function toASCII($str)// phpcs:ignore
    {
        return strtr(
            utf8_decode($str),
